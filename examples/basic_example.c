...
int main(void) {
    ...
    RayDialComponent* messageLabel = CreateLabel(
        (Rectangle){ 120, 170, 560, 120 },  // Increased height for wrapped text
        "This is a basic example of using Raydial to create dialogue UIs. Text will now properly wrap within the bounds of this label component, preventing overflow and making the UI look much cleaner.",
        true  // Enable text wrapping
    );
